...
def Build_Tags(RG):
    ...
    for key in output['value']:
        ...
        print rg_output['properties']['instanceView']['statuses']['code']
        sys.exit(0)
        #Get the OS type
        ...
        NewIPTagList[ipaddress].append('azure-tag.vmPowerState.'+str(rg_output['properties']['instanceView']['statuses']['code']))
